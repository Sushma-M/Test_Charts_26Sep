...
public class QueryExecutionController {
    ...
    @RequestMapping(value = "/queries/deptQuery", method = RequestMethod.GET)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Object> executeDeptQuery(@RequestParam(value = "code", required = false) java.lang.String code, Pageable pageable) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named query deptQuery");
        Page<Object> result = queryService.executeDeptQuery(pageable, code);
